...
public class OrganizationService: IOrganizationService
{
	...
	public async Task<Organization> CreateOrganizationAsync(int regionId, string name)
	{
	...
	public async Task<GetOrganizationsResponse> GetAllOrganizationAsync(GetOrganizationsRequest request)
	{
	...
	public async Task<GetOrganizationsResponse> GetOrganizationAsync(GetOrganizationRequest request)
	{
	...
	public async Task RenameOrganizationAsync(long organizationId, string name)
	{
